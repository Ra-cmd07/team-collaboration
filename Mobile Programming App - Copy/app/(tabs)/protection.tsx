// app/(tabs)/protection.tsx - FIXED VERSION WITH ANIMATED BACKGROUND
...
const styles = StyleSheet.create({
  ...
  header: {
    paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 0) + verticalScale(5) : verticalScale(10),
